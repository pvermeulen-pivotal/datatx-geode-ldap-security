...
|                  | file:/path/filename - Master Key in secure file **The file: tag must preceed the file name and path**| 
|                  | credhub:name - The name in Credhub where the master encryption key is stored **The credhub: tag must preceed the name**|
